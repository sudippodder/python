...
def get_order_details(connection, order_id):
    ...
    query = "SELECT order_details.order_id, order_details.quantity, order_details.total_price, "\
            "product_table.name, product_table.price FROM order_details LEFT JOIN product_table on "\
            "order_details.product_id = product_table.product_id where order_details.order_id = %s"
